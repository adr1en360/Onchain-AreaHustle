...
export const api = {
  ...
  createHustlerProfile: (data: any) =>
    fetchApi("/users/hustler-profile", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updateHustlerProfile: (data: any) =>
    fetchApi("/users/hustler-profile", {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  ...
  activateTask: (id: string) =>
    fetchApi(`/tasks/${id}/activate`, { method: "POST" }),
  completeTask: (id: string) =>
    fetchApi(`/tasks/${id}/complete`, { method: "POST" }),
  voiceToIntent: (audioUrl: string) =>
    fetchApi(
      `/tasks/voice-to-intent?audio_url=${encodeURIComponent(audioUrl)}`,
      { method: "POST" },
    ),
  ...
  getWalletChallenge: (
    address: string,
    action: "link" | "register" | "login" | "auth" = "link",
  ) =>
